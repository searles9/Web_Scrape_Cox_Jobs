...
if __name__ == "__main__":
    ...
    if DEBUG:
        ...
        # Remote Jobs
        test_remote_url = "https://jobs.coxenterprises.com/job-search-results/?keyword=security&level=Individual%20Contributor&employment_type=Full-time&location=Norcross%2C%20GA%2C%20US&latitude=33.906&longitude=-84.184&radius=25&locationType=Nationwide"
        all_remote_jobs = scrape_jobs.get_jobs(test_remote_url)
    else:
        ...
        remote_url = "https://jobs.coxenterprises.com/job-search-results/?level=Individual%20Contributor&employment_type=Full-time&location=Norcross%2C%20GA%2C%20US&latitude=33.906&longitude=-84.184&radius=25&locationType=Nationwide"
        all_remote_jobs = scrape_jobs.get_jobs(remote_url)
    ...
    if SEND_EMAIL:
        ...
        utils.add_excel_sheet(security_roles,file,"General-Filter")
        # Send the email
