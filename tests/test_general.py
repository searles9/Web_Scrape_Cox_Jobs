...
from utils.utils import contains_term, filter_jobs_by_title

job_list = [
    ["Security Engineer 2", "Atlanta, GA", "Cox Automotive", "https://jobs.com"],
    ["Vehicle Condition Inspector", "Atlanta, GA",
        "Cox Automotive", "https://jobs.com"],
...
class TestStrings(unittest.TestCase):
    def test_contains_term(self):
        ...
        result = contains_term(the_string, the_list)
...
class CheckFilters(unittest.TestCase):
    ...
    def test_filter_bad_jobs(self):
        ...
        result = filter_jobs_by_title(job_list, bad_terms=bad_terms)
        expected_result = [["Security Engineer 2",
                            "Atlanta, GA", "Cox Automotive", "https://jobs.com"]]
    ...
    def test_filter_good_jobs(self):
        ...
        '''
        good_terms = ["Security"]
        result = filter_jobs_by_title(job_list, good_terms=good_terms)
        expected_result = [["Security Engineer 2",
                            "Atlanta, GA", "Cox Automotive", "https://jobs.com"]]
        self.assertEqual(result, expected_result)

    def test_filter_both(self):
        '''Filters down test data set to confirm it keeps the 
        good jobs and removes the bad ones.
        '''
        bad_terms = ["Vehicle"]
        good_terms = ["Security", "Software"]
        result = filter_jobs_by_title(
            job_list, bad_terms=bad_terms, good_terms=good_terms)
        expected_result = [
            ["Security Engineer 2", "Atlanta, GA",
                "Cox Automotive", "https://jobs.com"],
